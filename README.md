...
## Contexte
Ce projet est réalisé dans le cadre de la Licence 3 Mathématiques Appliquées à l'Université de Strasbourg. Il implémente un jeu de devinettes avec un chatbot utilisant C++17, CPR, JSON et Catch2 pour les tests.
